...
class CalcRST(object):
    ...
    def __init__(self, odict, fidict):
        """Initialize files and parameters.
        ::

         arguments:
            odict1 (dictionary):  model dictionary; array and file ops added
            filedict (dctionary): file operation dictionary
    ...
    def _rst_sect(self, dval):
        """Print section to reStructuredText.
        ::
    ...
    def _rst_term(self, dval2, termbegin):
        ...
        ::
         ...
         arguments:
            dval2 (dictionary value): [[t], statement, expr, ref ]
            termbegin (integer): flag to avoid blank lines in lists of terms
        """
        val1 = eval(dval2[2])
        ptype = type(val1)
    ...
    def _rst_check(self, dval):
        """Print check to reStructuredText.
        ::
    ...
    def _rst_array(self, dval):
        """Print array to reStructuredText.
        ::
    ...
    def _rst_func(self, dval):
        """Print function to reStructuredText.
        ::

         arguments:
            dval (dictionary value): [[f], function name, var, ref, eqn number]
    ...
    def _rst_eq(self, var3, dval):
        """Print equation to reStructuredText.
        ::
