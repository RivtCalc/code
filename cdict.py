...
class ModDicts(object):
    ...
    def build_mdict(self, curmod):
        ...
        Keys for equations, terms and evaluated functions are the
        dependent variable. Keys for other operations are generated by a
        line counter.
        ...
        dictionary values for operations
        -----------------------------------
        single line inputs:
        ...
        evaluated function [[z], statement]
        """
        ...
        for _i in self.mstrx:
            ...
            if pend in pendlist and mtag != '[~]':
                ...
                continue
            if pend in pendlist and mtag == '[~]':
                if pend ==   'd': self._tag_d(ip)  # 'e' option only
