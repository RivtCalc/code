...
class ModDict(object):
    ...
    def _build_mdict(self):
        ...
        1[s]
         ...
         A dictionary entry contains up to 10 parameters delineated by
         commas, | or #- in the model file. Standard Python comments
        ...
        for il in self.mainmod:
            ...
            if mtag in self.mtags:
                if mtag == '#- ':
                    ...
                    #print ('tag #-', il)
                    continue
                elif mtag == '[r]': self._tag_r(il)
                elif mtag == '[i]': self._tag_i(il)
                elif mtag == '[v]':
                    ip += il
                    pend = 'v'
                elif mtag == '[e]':
