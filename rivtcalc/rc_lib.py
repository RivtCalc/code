...
"""exposes RivtCalc API.  
    ...
    The API includes five string input and four output functions. Input
    functions take rivt markup strings as arguments and output utf-formatted
    calculation documents to the terminal or interactive pane in a code editor.
    Ouput functions write formatted calculation documents to files in utf, pdf
    and html formats. rivt markup may include unicode text, Python code,
    reStructuredText and rivt commands and tags.

    Input functions
    ========= ======= ===== ====== ==============================================
    type      functon text  tags    commands
    ========= ======= ===== ====== ==============================================
    1. repo     R()   yes    no    heading, tag, attach
    2. insert   I()   yes    yes   tex, sym, text, table, image
    3. value    V()   yes    yes   =, format, values, data +insert commands
    4. table    T()   no     yes   Python simple statements +insert commands  
    5. skip     S()   --      --   skip processing of rivt-string
    ========= ======= ===== ====== ==============================================
