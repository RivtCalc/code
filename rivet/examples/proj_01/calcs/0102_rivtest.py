...
v__(''' some values 
    ...
    BEAM1 < aisc13.csv[4]       | row vector from file 
    BEAM2 # aisc13.csv[2]       | column vector from file 
    I_x = BEAM1[2]              | I major
    I_y = BEAM1[3]              | I minor
...
e__(''' equations string
    ...
    | func | scripts1.py | pin_pin(a11, a22) | FT*LB, N*M
    | func | scripts1.py | fixed_fixed(a11, a22) | FT*LB, N*M
